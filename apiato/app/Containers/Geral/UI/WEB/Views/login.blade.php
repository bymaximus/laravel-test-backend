...
<head>
	...
	<link rel="stylesheet" href="{{ asset(mix('container/admin/css/login.css')) }}">
...
<body>
	...
	<script src="{{ asset(mix('container/admin/js/login/manifest.js')) }}"></script>
	<script src="{{ asset(mix('container/admin/js/login/vendor.js')) }}"></script>
	<script src="{{ asset(mix('container/admin/js/login.js')) }}"></script>
</body>
