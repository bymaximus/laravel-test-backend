...
class ObterVisualizarRegistroRequest extends Request
{
     ...
     * @var string
     */
    protected $transporter = \App\Containers\Geral\Data\Transporters\Cadastro\Imovel\ObterVisualizarRegistroTransporter::class;
