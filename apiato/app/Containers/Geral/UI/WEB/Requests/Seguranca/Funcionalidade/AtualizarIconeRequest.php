...
class AtualizarIconeRequest extends Request
{
	 ...
	 * @var string
	 */
	protected $transporter = \App\Containers\Geral\Data\Transporters\Seguranca\Funcionalidade\AtualizarIconeTransporter::class;
