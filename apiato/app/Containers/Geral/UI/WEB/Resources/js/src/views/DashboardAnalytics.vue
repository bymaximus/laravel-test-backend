			...
			<div class="vx-col w-full mb-base">
				...
				>
					...
					<feather-icon
						...
						svgClasses="h-8 w-8"
					></feather-icon>
					<h1 class="mb-6 text-white">Bem vindo,</h1>
					<p class="xl:w-3/4 lg:w-4/5 md:w-2/3 w-4/5 mx-auto text-white">Use o menu lateral esquerdo para acessar as páginas de cadastro.</p>
				</vx-card>
			</div>
		</div>
	</div>
