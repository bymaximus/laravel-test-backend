let titulo = 'Cidade';
let url = 'cidade';
let icone = 'fa fa-city';

module.exports = [
	{
		path: '/cadastro/' + url,
		name: 'cadastro-' + url,
		component: () => import('@/views/apps/cadastro/Cidade/Index.vue'),
		meta: {
			breadcrumb: [
				{
					title: 'Início',
		...
		component: () => import('@/views/apps/cadastro/Cidade/CriarRegistro.vue'),
		meta: {
			breadcrumb: [
				{
					title: 'Início',
		...
		component: () => import('@/views/apps/cadastro/Cidade/EditarRegistro.vue'),
		props: true,
		meta: {
			breadcrumb: [
				{
		...
		component: () => import('@/views/apps/cadastro/Cidade/Historico/Index.vue'),
		props: true,
		meta: {
			breadcrumb: [
				{
		...
		component: () => import('@/views/apps/cadastro/Cidade/Historico/VisualizarRegistro.vue'),
		props: true,
		meta: {
			breadcrumb: [
				{
		...
		component: () => import('@/views/apps/cadastro/Cidade/Removido/Index.vue'),
		props: true,
		meta: {
			breadcrumb: [
				{
		...
		component: () => import('@/views/apps/cadastro/Cidade/HistoricoRemovido/Index.vue'),
		props: true,
		meta: {
			breadcrumb: [
				{
		...
		component: () => import('@/views/apps/cadastro/Cidade/HistoricoRemovido/VisualizarRegistro.vue'),
		props: true,
		meta: {
			breadcrumb: [
				{
