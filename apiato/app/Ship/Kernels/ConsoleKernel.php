...
class ConsoleKernel extends LaravelConsoleKernel
{
	...
	protected function schedule(Schedule $schedule)
	{
		...
		//$schedule->command('creationshop:api:test')->withoutOverlapping()->everyMinute();
		//$schedule->command('creationshop:api:ipn:process')->withoutOverlapping(60)->everyMinute();
		//$schedule->command('creationshop:api:subscription:process')->withoutOverlapping(60)->everyMinute();
	}
