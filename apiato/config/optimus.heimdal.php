...
return [
	...
	'formatters' => [
		...
		\Illuminate\Validation\ValidationException::class => \App\Containers\Geral\Exceptions\Formatters\ValidationExceptionFormatter::class,
		...
		Illuminate\Auth\Access\AuthorizationException::class => \App\Containers\Geral\Exceptions\Formatters\AuthorizationExceptionFormatter::class,
		...
		SymfonyException\HttpException::class => \App\Containers\Geral\Exceptions\Formatters\HttpExceptionFormatter::class,
